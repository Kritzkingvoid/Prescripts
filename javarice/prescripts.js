...
function createMessages() {
  return [
    ...
    { text: "ACTIVATE AN ABSOLUTE RESONANCE THIS TURN", weight: 40, minCount: 0, amounts: 3 },
    ...
    { text: "CHAIN AT LEAST 3 SKILL SLOTS WITH THE SAME SIN-AFFINITY", weight: 10, minCount: 5, amounts: 5 },
